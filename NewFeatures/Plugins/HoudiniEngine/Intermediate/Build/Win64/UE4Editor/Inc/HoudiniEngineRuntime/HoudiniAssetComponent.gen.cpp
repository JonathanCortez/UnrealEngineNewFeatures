...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_HoudiniEngineRuntime_EHoudiniEngineBakeOption_Hash() { return 760456690U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bHasHoudiniAssetEditor_MetaData[];
#endif
		static void NewProp_bHasHoudiniAssetEditor_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bHasHoudiniAssetEditor;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasHoudiniAssetEditor_MetaData[] = {
		{ "ModuleRelativePath", "Private/HoudiniAssetComponent.h" },
	};
#endif
	void Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasHoudiniAssetEditor_SetBit(void* Obj)
	{
		((UHoudiniAssetComponent*)Obj)->bHasHoudiniAssetEditor = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasHoudiniAssetEditor = { "bHasHoudiniAssetEditor", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniAssetComponent), &Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasHoudiniAssetEditor_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasHoudiniAssetEditor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasHoudiniAssetEditor_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHoudiniAssetComponent_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniAssetComponent_Statics::NewProp_bHasHoudiniAssetEditor,
	...
	IMPLEMENT_CLASS(UHoudiniAssetComponent, 3630063672);
