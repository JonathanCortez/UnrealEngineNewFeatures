...
class FHoudiniAssetViewportLODCommands : public TCommands<FHoudiniAssetViewportLODCommands>
{
public:
	FHoudiniAssetViewportLODCommands()
		: TCommands<FHoudiniAssetViewportLODCommands>
		(
