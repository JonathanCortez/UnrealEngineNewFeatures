...
class FHoudiniAssetDetails : public IDetailCustomization
{
public:
	FHoudiniAssetDetails( class FHoudiniAssetEditor& InHoudiniAssetEditor );
	~FHoudiniAssetDetails();
...
// 	TSharedPtr<FLevelOfDetailSettingsLayout> LevelOfDetailSettings;
	...
	/** Static mesh editor */
	class FHoudiniAssetEditor& HoudiniAssetEditor;
//
...
{
public:
	FMeshSectionSettingsLayout( IHoudiniAssetEditor& InHoudiniAssetEditor, int32 InLODIndex, TArray<class IDetailCategoryBuilder*> &InLodCategories)
...
private:
	...
	UHoudiniAssetEditorObject& GetHoudiniAsset() const;
	...
	*/
	...
	IHoudiniAssetEditor& HoudiniAssetEditor;
	int32 LODIndex;
...
{
public:
	FMeshMaterialsLayout(IHoudiniAssetEditor& InHoudiniAssetEditor)
		: HoudiniAssetEditor(InHoudiniAssetEditor)
	{
...
{
public:
	FLevelOfDetailSettingsLayout( FHoudiniAssetEditor& HoudiniAssetEditor );
...
private:
	...
	FHoudiniAssetEditor& HoudiniAssetEditor;
